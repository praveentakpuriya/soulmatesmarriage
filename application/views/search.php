      ...
      <div class="container">
       ...
       <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item active"><a href="#" class="nav-link dropdown-toggle"
                    ...
                    <div class="col-md-8 col-sm-12 col-xs-12">
                      <div class="mega-box-new">
                        <div class="m-add-box">
                          ...
                          <form class="form-horizontal" id="quickserch" name="quickserch">
                            ...
                            <div class="form-group">
                              ...
                              <div class="form-check ml-1 mb-2 mr-3">
                                  <input class="form-check-input" required="" name="sex1" type="radio" value="" id="groom">
                                  <label class="form-check-label" for="groom">
                                Groom                                  </label>
                                </div>
                                <div class="form-check ml-1 mb-2">
                                  <input class="form-check-input" required="" name="sex1"  type="radio" value="" id="bride">
                            ...
                            <div class="form-group">
                              <div class="row">
                                ...
                                <div class="col-sm-9 col-md-9">
                                  <select name='lstreligion' id='lstreligion' class='form-control ' style=''>
                                    <option value='Any' selected='selected'>Any Religion
                                    </option>
                                    <option value='Buddhist'>Buddhist</option>
                                    <option value='Christian'>Christian</option>
                                    <option value='Christian - Catholic'>Christian - Catholic
                                    </option>
                                    <option value='Christian - Orthodox'>Christian - Orthodox
                                    </option>
                                    <option value='Christian - Protestant'>Christian -
                                      Protestant</option>
                                    ...
                                    <option value='Muslim Shiya'>Muslim Shiya</option>
                            ...
                            <div class="form-group">
                              <div class="row">
                                ...
                                <div class="col-sm-9 col-md-9">
                                  <select name='mtongue' onchange='ddchange(this.value);newddchange(this);' id='mtongue' class='form-control ' style=''>
                        ...
                        <div class="m-add-box">
                          ...
                          <form action="#" method="post">
                            <div class="form-group">
                              ...
                              <div class="form-check ml-1 mb-2 mr-3">
                                  <input class="form-check-input" required="" name="sex" type="radio" value="" id="privacy1">
                                  <label class="form-check-label" for="privacy1">
                                Groom                                  </label>
                                </div>
                                <div class="form-check ml-1 mb-2">
                                  <input class="form-check-input" required="" name="sex"  type="radio" value="" id="privacy">
                            ...
                            <div class="form-group">
                              <div class="row">
                                ...
                                <div class="col-sm-9 col-md-9">
                                  <input name="txtkey" type="text" id="txtkey" class="form-control description" size="40">
