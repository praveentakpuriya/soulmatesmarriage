    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12" id="quicksearch">
                <div class="search-wrap-1 mb-5" id="rotate" style="margin-top: -234px;
                            ...
                            <div class="col-lg align-items-end">
                                <div class="form-group">
                                    ...
                                    <div class="form-field">
                                        <div class="select-wrap">
                                            <div class="icon"><span class="ion-ios-arrow-down"></span></div>
                                            <select name='lstreligion' onchange='ddchange(this.value);newddchange(this);' id='lstreligion' class='required form-control selectpicker' style='#'>
                            ...
                            <div class="col-lg align-items-end">
                                <div class="form-group">
                                    ...
                                    <div class="form-field">
                                        <div class="select-wrap">
                                            <div class="icon"><span class="ion-ios-arrow-down"></span></div>
                                            <select name='mtongue' onchange='ddchange(this.value);newddchange(this);' id='mtongue' class='required form-control selectpicker' style='#'>
