                ...
                <div class="col-md-3">
                    <form action="" method="post">
                        ...
                        <div class="form-group col-sm-12"
                            style="    box-shadow: 5px 6px 15px 4px #bbbbbbbd;background-color: #fff;border: 1px solid #fff;border-radius: 5px; padding: 15px;">
                                ...
                                <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                                        ...
                                        <div class="panel-heading" role="tab" id="headingTwo">
                                            <a class="collapsed" role="button" data-toggle="collapse"
                                                ...
                                                <h4 class="panel-title">
                                                    ...
                                                    Marital Status <span style="float: right;"><i
                                        ...
                                        <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel"
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <span class="custom-checkbox ">
                                                    <input class="js-cluster" false="" type="checkbox"
                                                        name="marital_status[]" value="Never Married">
                                                ...
                                                <span class="custom-checkbox ">
                                                    <input class="js-cluster" false="" type="checkbox"
                                                        name="marital_status[]" value="Separated">
                                                </span>Separated<br>
                                        ...
                                        <div class="panel-heading" role="tab" id="headingThree">
                                            <a class="collapsed" role="button" data-toggle="collapse"
                                                ...
                                                <h4 class="panel-title">
                                                    ...
                                                    Religion <span style="float: right;"><i
                                                            class="fa fa-chevron-down"></i></span>
                                        ...
                                        <div class="panel-heading" role="tab" id="headingfive">
                                            <a class="collapsed" role="button" data-toggle="collapse"
                                                ...
                                                <h4 class="panel-title">
                                                    ...
                                                    Mother Tongue <span style="float: right;"><i
                                                            class="fa fa-chevron-down"></i></span>
                                        ...
                                        <div class="panel-heading" role="tab" id="headingeight">
                                            <a class="collapsed" role="button" data-toggle="collapse"
                                                ...
                                                <h4 class="panel-title">
                                                    ...
                                                    Education <span style="float: right;"><i
                                                            class="fa fa-chevron-down"></i></span>
                                        ...
                                        <div class="panel-heading" role="tab" id="headingnine">
                                            <a class="collapsed" role="button" data-toggle="collapse"
                                                ...
                                                <h4 class="panel-title">
                                                    ...
                                                    Occupation <span style="float: right;"><i
                                                            class="fa fa-chevron-down"></i></span>
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading" role="tab" id="headingten">
                                            <a class="collapsed" role="button" data-toggle="collapse"
                                                ...
                                                <h4 class="panel-title">
                                                    ...
                                                    Income Between <span style="float: right;"><i
                                                            class="fa fa-chevron-down"></i></span>
                                        ...
                                        <div id="collapseten" class="panel-collapse collapse" role="tabpanel"
                                            ...
                                            <div class="panel-body">
                                                <input type="text" name="minincome" id="minincome" class="form-control"
                                                    value="" placeholder="Income From" /><br>
                                                <input type="text" name="maxincome" id="maxincome" class="form-control"
                                                    value="" placeholder="Income To" />
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <p class="p-search OpenSans-Bold" style="margin-bottom:0px;">
                                            Shubham </p>
                                        <span class="p-search2"><i class="icon icon-user"></i>&nbsp;<a
                                                href="profile.php?id=SH421210" target="_blank">SH421210</a> &nbsp; |
                                            &nbsp; Free Member</span>
                                    </div>
                                        ...
                                        <div class="">
                                            <div class="row">
                                                ...
                                                <div class="main-short row">
                                                    <div class="col-md-4 col-xs-4 col-sm-4">
                                                        <div class="tooltip" style="display:block">
                                                            <a href="#" target="_blank"><i
                                                                    class="sr-i1 sr-icon fa fa-user"
                                                    ...
                                                    <div class="col-md-4 col-xs-4 col-sm-4">
                                                        <a class="tooltip" style="display:inline-block;" href="#"
                                                            target="_blank">
                                                    ...
                                                    <div class="col-md-4 col-xs-4 col-sm-4">
                                                        <a class="tooltip" style="display:inline-block;" href="#"
                                                            target="_blank">
                                                            <i class="fa fa-envelope-o sr-i2 sr-icon"
                                                                aria-hidden="true"></i>
