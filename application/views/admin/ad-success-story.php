      ...
      <div class="main-sidebar-body">
        <ul class="nav">
          ...
          <li class="nav-item">
           ...
           <li class="nav-item">
            <a href="Ad_Success_Story" class="nav-link active" ><span class="shape1"></span><span class="shape2"></span>
            ...
            <div class="main-profile-menu">
              ...
              <div class="dropdown-menu">
               ...
               <!--  <a class="dropdown-item border-top" href="#">
                ...
                <a class="dropdown-item border-top" href="Admin_Login/logoutassets/">
                ...
                <div class="container-fluid">
                    <div class="inner-body">
                        ...
                        <div class="page-header">
                            <div>
                                <h2 class="main-content-title tx-24 mg-b-5">Add Success Stroy</h2>
                                <ol class="breadcrumb">
                                    ...
                                    <div class="card-body">
                                        <div class="row justify-content-center">
                                         ...
                                         <div class='mb-4 col-lg-3'>
                                            ...
                                            <label class="title-col">Upload Photo</label>
                                            
                                            <input id="categor" class="form-control filter-input" name="name" autoComplete="off" type="file" required
