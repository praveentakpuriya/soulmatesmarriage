  ...
  <div class="main-sidebar main-sidebar-sticky side-menu">
    ...
    <div class="main-sidebar-body">
      <ul class="nav">
        ...
        <li class="nav-item ">
          <a href="Admin_Dashboard" class="nav-link active"><span class="shape1"></span><span class="shape2"></span>
            <i class="fad fa-home-lg sidemenu-icon"></i>
            <span class="sidemenu-label">Dashboard</span></a>
        </li>

        <li class="nav-item">
          <a class="nav-link" href="Ad_User_Management"><span class="shape1"></span><span class="shape2"></span>
